...
namespace Haeretici\OnRemoveLocationAfterWorkflowBundle\Workflow\Service;

use Haeretici\OnRemoveLocationAfterWorkflowBundle\Workflow\EventType\OnRemoveLocationAfterEventType;

final class OnRemoveLocationAfterEventTypeLogger
{
    public const LOG_FILENAME = 'OnRemoveLocationAfterEventType.log';
    ...
    public function logTriggered(array $parameters): void
    {
        $payload = json_encode(
            [
                ...
                'event_type' => OnRemoveLocationAfterEventType::TYPE_STRING,
