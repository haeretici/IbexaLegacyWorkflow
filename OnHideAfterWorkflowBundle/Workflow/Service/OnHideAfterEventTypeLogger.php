...
namespace Haeretici\OnHideAfterWorkflowBundle\Workflow\Service;

use Haeretici\OnHideAfterWorkflowBundle\Workflow\EventType\OnHideAfterEventType;

final class OnHideAfterEventTypeLogger
{
    public const LOG_FILENAME = 'OnHideAfterEventType.log';
    ...
    public function logTriggered(array $parameters): void
    {
        $payload = json_encode(
            [
                ...
                'event_type' => OnHideAfterEventType::TYPE_STRING,
