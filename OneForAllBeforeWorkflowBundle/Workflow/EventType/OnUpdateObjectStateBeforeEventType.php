...
class OnUpdateObjectStateBeforeEventType extends AbstractWorkflowEventType
{
    public const TYPE_STRING = 'event_haeretici_onupdateobjectstatebefore';
    ...
    public function __construct(
        ...
        parent::__construct(
            self::TYPE_STRING,
            'On update object state before',
            ['content' => ['updateobjectstate' => ['before']]]
        );
    }
    ...
    public function execute(WorkflowProcess $process, WorkflowEvent $event): int
    {
        ...
        $this->setInformation(sprintf(
            'Pre-updateobjectstate hook ran for content %d version %d',
