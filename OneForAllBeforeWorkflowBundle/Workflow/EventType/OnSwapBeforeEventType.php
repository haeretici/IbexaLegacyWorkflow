...
class OnSwapBeforeEventType extends AbstractWorkflowEventType
{
    public const TYPE_STRING = 'event_haeretici_onswapbefore';
    ...
    public function execute(WorkflowProcess $process, WorkflowEvent $event): int
    {
        ...
        $this->setInformation(sprintf(
            'Pre-swap hook ran for content %d version %d',
