...
class OnRemoveTranslationBeforeEventType extends AbstractWorkflowEventType
{
    public const TYPE_STRING = 'event_haeretici_onremovetranslationbefore';
    ...
    public function __construct(
        ...
        parent::__construct(
            self::TYPE_STRING,
            'On remove translation before',
            ['content' => ['removetranslation' => ['before']]]
        );
    }
    ...
    public function execute(WorkflowProcess $process, WorkflowEvent $event): int
    {
        ...
        $this->setInformation(sprintf(
            'Pre-removetranslation hook ran for content %d version %d',
