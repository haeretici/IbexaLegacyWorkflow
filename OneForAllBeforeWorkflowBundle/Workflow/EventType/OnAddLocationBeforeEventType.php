...
class OnAddLocationBeforeEventType extends AbstractWorkflowEventType
{
    public const TYPE_STRING = 'event_haeretici_onaddlocationbefore';
    ...
    public function __construct(
        ...
        parent::__construct(
            self::TYPE_STRING,
            'On add location before',
            ['content' => ['addlocation' => ['before']]]
        );
    }
    ...
    public function execute(WorkflowProcess $process, WorkflowEvent $event): int
    {
        ...
        $this->setInformation(sprintf(
            'Pre-addlocation hook ran for content %d version %d',
